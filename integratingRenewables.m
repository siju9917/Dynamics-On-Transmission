...
for trial = 1:numTrials
    ...
    for t = 1:numTimeSteps
        ...
        singleOscillatorFrequencyR(t) = WnVector(23);
...
figure(1)
plot(avgFrequencyFrom0+57.5)
title('Average Frequency of Entire Power System')
ylabel('Frequency in Hertz')
xlabel('Time')
figure(2)
plot(coupledComponent1Timestep)
figure(3)
plot(singleOscillatorFrequencyR+60)
title('Frequency of a Single Renewable Generator')
ylabel('Frequency in Hertz')
xlabel('Time')
figure(4)
plot(singleOscillatorFrequency+60)
title('Frequency of a Single Nonrenewable Generator')
ylabel('Frequency in Hertz')
xlabel('Time')
